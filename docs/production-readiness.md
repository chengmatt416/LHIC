...
- The direct executor enforces the risk policy itself: high-risk, unknown-risk, and custom actions require a matching, expiring human approval. In production, a high-risk approval must be signed by an external human-approval authority using Ed25519.
